...
from organization_github.create_file_issue_and_pull.thread_issue_and_pull import ThreadIssueAndPull
from organization_github.create_file_issue_and_pull.token_access import TokenAccess
...
from organization_github.control_files_repository import ControlFilesRepository
...
class Organizations:
    ...
    def __init__(self, directory, organization, tokens):
        self._dir = directory
        ...
        for repo in org.get_repos():
            ...
            repository: Repositories = Repositories(repo.name, repo.html_url, self.members_repository(repo), repo.fork,
                                                    ...
                                                    percentage, self._dir, self._name_file_issue,
    ...
    def get_first_filter(self):
        name_file = 'first filter ' + self.__organization + '.csv'
        file = open(name_file, 'wt')
        try:
            writer: csv.DictWriter = csv.writer(file)
            writer.writerow(
    ...
    def get_second_filter(self):
        name_file = 'second filter ' + self.__organization + '.csv'
        file = open(name_file, 'wt')
        try:
            writer: csv.DictWriter = csv.writer(file)
            writer.writerow(
    ...
    def get_third_filter(self):
        name_file = 'third filter ' + self.__organization + '.csv'
        file = open(name_file, 'wt')
        try:
            writer: csv.DictWriter = csv.writer(file)
            writer.writerow(
    ...
    def get_fourth_filter(self):
        name_file = 'fourth filter ' + self.__organization + '.csv'
        file = open(name_file, 'wt')
        try:
            writer: csv.DictWriter = csv.writer(file)
            writer.writerow(
    ...
    def get_fifth_filter(self):
        name_file = 'fifth filter ' + self.__organization + '.csv'
        file = open(name_file, 'wt')
        try:
            writer: csv.DictWriter = csv.writer(file)
            writer.writerow(
    ...
    def get_sixth_filter(self):
        name_file = 'sixth filter ' + self.__organization + '.csv'
        file = open(name_file, 'wt')
        try:
            writer: csv.DictWriter = csv.writer(file)
            writer.writerow(
