...
class Associations:
    ...
    def __init__(self, directory, repository, channel, name_organization, name_file_issue, name_file_comments_issue,
                 name_file_pull_request, name_file_comments_pull_request):
        self._repository = repository
        self._channel = channel
        self._name_organization = name_organization
        self._name_file_issue = directory + '/' + self._name_organization + '/' + name_file_issue
        self._name_file_comments_issue = directory + '/' + self._name_organization + '/' + name_file_comments_issue
        self._name_file_pull_request = directory + '/' + self._name_organization + '/' + name_file_pull_request
        self._name_file_comments_pull_request = \
            directory + '/' + self._name_organization + '/' + name_file_comments_pull_request
